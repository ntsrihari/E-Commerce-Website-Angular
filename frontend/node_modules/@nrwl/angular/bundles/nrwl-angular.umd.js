(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@ngrx/store'),require('@ngrx/effects'),exports, require('@angular/core'), require('@ngrx/effects'), require('@ngrx/router-store'), require('@ngrx/store'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@nrwl/angular', ['@angular/core','@ngrx/store','@ngrx/effects','exports', '@angular/core', '@ngrx/effects', '@ngrx/router-store', '@ngrx/store', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngrx.store,global.ngrx.effects,(global.nrwl = global.nrwl || {}, global.nrwl.angular = {}), global.ng.core, global.ngrx.effects, global.ngrx.routerStore, global.ngrx.store, global.rxjs, global.rxjs.operators));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, core, effects, routerStore, store, rxjs, operators) { 'use strict';
...
DataPersistence.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: DataPersistence, factory: function (t) { return DataPersistence.ɵfac(t); } });
